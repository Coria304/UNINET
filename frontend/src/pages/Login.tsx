...
function Login() {
  ...
  return (
    <div className="min-h-screen grid place-items-center bg-[#F7F6F3] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#787774] mt-1">
            Acceso con cuenta institucional ESCOM
          </p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="bg-white border border-[#EAEAEA] rounded-lg p-6 space-y-4"
        >
        ...
        <p className="text-xs text-[#AAAAAA] text-center mt-4">
