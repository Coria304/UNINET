  ...
  return (
    <div className="flex min-h-screen">
      ...
      <aside className="w-56 bg-brand-900 flex flex-col shrink-0">
        ...
        <div className="px-5 py-4 border-t border-white/[0.08] text-xs">
          <div className="text-white/90 font-medium truncate">
            {usuario?.nombre_completo}
          </div>
          <div className="text-white/40 mt-0.5">Personal Técnico</div>
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#F5F8FF]">
        <div className="flex justify-end items-center px-6 py-3 bg-white border-b border-[#E2E8F0]">
